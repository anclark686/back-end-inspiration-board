...
with my_app.app_context():
    db.session.add(Card(message = "A New Card", likes_count = 0)) 
    db.session.add(Card(message = "A Newer Card", likes_count = 1)) 
    db.session.add(Card(message = "A Cool Card", likes_count = 0)) 
    db.session.add(Card(message = "A Cooler Card", likes_count = 2)) 
    db.session.add(Card(message = "A Neat Card", likes_count = 0)) 
    db.session.add(Card(message = "An Awesome Card", likes_count = 3)) 
    db.session.add(Card(message = "An Uncreative Card", likes_count = 0)) 
    db.session.add(Card(message = "An Old Card", likes_count = 4)) 
